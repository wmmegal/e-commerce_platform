        ...
        <div class="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="grid grid-cols-2 column-gap-6">
                @forelse($products as $product)
                    <a href="{{ route('product-show', $product) }}" class="border-b py-3 space-y-2 flex items-center">
                        <div>
            ...
            <a href="#" class="inline-block text-indigo-500 mt-6" wire:click.prevent="clearSearch">Clear search</a>
        </div>
    @endif
</nav>
